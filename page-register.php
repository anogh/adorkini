    ...
    <div class="container mx-auto px-4 py-8 max-w-md">
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-6 dark:border-gray-700 dark:bg-background-dark">
            ...
            <form method="post" id="register-form">
                ...
                <button type="submit" name="warafy_register" class="mt-6 flex w-full cursor-pointer items-center justify-center overflow-hidden rounded-lg h-12 px-6 bg-primary text-white text-base font-bold hover:bg-primary/90 transition-colors">

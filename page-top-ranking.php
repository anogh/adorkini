                        ...
                        foreach ($products as $item) {
                            ...
                            <div class="flex items-center gap-4 p-4 rounded-xl border-2 <?php echo $border_class; ?> <?php echo $bg_class; ?> dark:border-gray-700 dark:bg-background-dark hover:shadow-lg transition-all ranking-item relative overflow-hidden">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <!-- Action Buttons -->
                                    <div class="mt-3">
                                        <button class="add-to-cart-btn flex items-center gap-2 px-3 py-2 bg-primary/10 text-primary text-sm font-bold rounded-lg hover:bg-primary/20 dark:bg-primary/20 dark:hover:bg-primary/30 transition-colors justify-center w-full" data-product-id="<?php echo $item['product']->get_id(); ?>" title="<?php echo __t('Add to Cart'); ?>">

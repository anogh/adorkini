            ...
            <section class="grid grid-cols-1 gap-8 lg:grid-cols-2">
                ...
                <div class="flex flex-col gap-6">
                    ...
                    <form class="cart flex flex-col gap-4" action="<?php echo esc_url( apply_filters( 'woocommerce_add_to_cart_form_action', $product->get_permalink() ) ); ?>" method="post" enctype='multipart/form-data'>
                        ...
                        <!-- Buy Now Button -->
                        <button type="button" class="buy-now-btn w-full bg-red-500 hover:bg-red-600 text-white font-bold text-lg py-2.5 rounded-lg text-center transition-colors shadow-md" data-product-id="<?php echo $product->get_id(); ?>" data-checkout-url="<?php echo esc_url( wc_get_checkout_url() ); ?>" title="<?php echo __t('ORDER NOW'); ?>">
